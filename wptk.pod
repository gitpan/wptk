...
wptk obviates the need to write standard perl/Tk boiler-plate code.  Every
...
wptk provides this template code for you automatically, then sources
...
By default the MainWindow is $mw, which can be changed in the
above template.
